...
export class ControleLivrosService {
  livros: Array<Livro> = [
    ...
    },
    {
      ...
      resumo: 'Readers familiar with Horstmanns original, two-volume "Core Java" books who are looking for a comprehensive, but condensed guide to the new features in Java SE 9 will learn how these new features impact the language and core libraries.',
